...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="JKCalendar",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10JKCalendar10JKCalendar")
@interface JKCalendar : UIView
...
@class JKInfinitePageView;

@interface JKCalendar (SWIFT_EXTENSION(JKCalendar)) <JKInfinitePageViewDataSource>
- (UIView * _Nonnull)infinitePageView:(JKInfinitePageView * _Nonnull)infinitePageView viewBefore:(UIView * _Nonnull)view SWIFT_WARN_UNUSED_RESULT;
- (UIView * _Nonnull)infinitePageView:(JKInfinitePageView * _Nonnull)infinitePageView viewAfter:(UIView * _Nonnull)view SWIFT_WARN_UNUSED_RESULT;
@end


@interface JKCalendar (SWIFT_EXTENSION(JKCalendar)) <JKInfinitePageViewDelegate>
- (void)infinitePageView:(JKInfinitePageView * _Nonnull)infinitePageView afterWith:(UIView * _Nonnull)view progress:(double)progress;
- (void)infinitePageView:(JKInfinitePageView * _Nonnull)infinitePageView beforeWith:(UIView * _Nonnull)view progress:(double)progress;
@end


SWIFT_CLASS("_TtC10JKCalendar20JKCalendarMarkObject")
@interface JKCalendarMarkObject : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC10JKCalendar24JKCalendarContinuousMark")
@interface JKCalendarContinuousMark : JKCalendarMarkObject
@end

@class JKMonth;
@class JKCalendarMark;

SWIFT_PROTOCOL("_TtP10JKCalendar20JKCalendarDataSource_")
@protocol JKCalendarDataSource
@optional
- (NSArray<JKCalendarMark *> * _Nullable)calendar:(JKCalendar * _Nonnull)calendar marksWith:(JKMonth * _Nonnull)month SWIFT_WARN_UNUSED_RESULT;
- (NSArray<JKCalendarContinuousMark *> * _Nullable)calendar:(JKCalendar * _Nonnull)calendar continuousMarksWith:(JKMonth * _Nonnull)month SWIFT_WARN_UNUSED_RESULT;
@end

@class JKDay;
enum JKCalendarViewStatus : NSInteger;

SWIFT_PROTOCOL("_TtP10JKCalendar18JKCalendarDelegate_")
@protocol JKCalendarDelegate
@optional
- (void)calendar:(JKCalendar * _Nonnull)calendar didTouch:(JKDay * _Nonnull)day;
- (void)calendar:(JKCalendar * _Nonnull)calendar didPan:(NSArray<JKDay *> * _Nonnull)days;
- (void)calendar:(JKCalendar * _Nonnull)calendar didChangedStatus:(enum JKCalendarViewStatus)status;
- (void)calendar:(JKCalendar * _Nonnull)calendar didChangedMonth:(JKMonth * _Nonnull)month;
- (CGFloat)heightOfFooterViewIn:(JKCalendar * _Nonnull)calendar SWIFT_WARN_UNUSED_RESULT;
- (UIView * _Nullable)viewOfFooterIn:(JKCalendar * _Nonnull)calendar SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC10JKCalendar14JKCalendarMark")
@interface JKCalendarMark : JKCalendarMarkObject
@end



SWIFT_CLASS("_TtC10JKCalendar20JKCalendarScrollView")
@interface JKCalendarScrollView : UIScrollView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)layoutSubviews;
@end
...
@interface JKCalendarScrollView (SWIFT_EXTENSION(JKCalendar)) <UIScrollViewDelegate>
...
SWIFT_CLASS("_TtC10JKCalendar19JKCalendarTableView")
@interface JKCalendarTableView : UITableView
...
@interface JKCalendarTableView (SWIFT_EXTENSION(JKCalendar)) <UITableViewDelegate>
- (void)scrollViewDidScroll:(UIScrollView * _Nonnull)scrollView;
- (void)scrollViewDidZoom:(UIScrollView * _Nonnull)scrollView;
- (void)scrollViewWillBeginDragging:(UIScrollView * _Nonnull)scrollView;
- (void)scrollViewWillEndDragging:(UIScrollView * _Nonnull)scrollView withVelocity:(CGPoint)velocity targetContentOffset:(CGPoint * _Nonnull)targetContentOffset;
...
typedef SWIFT_ENUM(NSInteger, JKCalendarViewStatus, closed) {
  JKCalendarViewStatusCollapse = 0,
  JKCalendarViewStatusBetween = 1,
  JKCalendarViewStatusExpand = 2,
};


SWIFT_CLASS("_TtC10JKCalendar6JKYear")
@interface JKYear : NSObject
...
SWIFT_CLASS("_TtC10JKCalendar7JKMonth")
@interface JKMonth : JKYear
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC10JKCalendar5JKDay")
@interface JKDay : JKMonth
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end
